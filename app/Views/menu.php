  ...
  <div class="container">
    ...
    <div class="row justify-content-center mb-5 pb-3">
      <div class="col-md-7 heading-section text-center ftco-animate">
        <span class="subheading">Racik Sendiri</span>
        <h2 class="mb-4">Pilih Kopi Favoritmu</h2>
        <p>Nikmati pengalaman meracik kopi sendiri. Pilih biji kopi, tingkat roasting, dan topping sesuai selera.</p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3 text-center ftco-animate">
        <div class="menu-entry">
          <a class="img" style="background-image: url(<?= base_url('coffee1-gh-pages/images/menu-1.jpg') ?>);"></a>
          <div class="text pt-4">
            <h3>Kopi Joss Original</h3>
            <p>Kopi hitam panas dengan arang membara, aroma smoky khas Jogja.</p>
      ...
      <div class="col-md-3 text-center ftco-animate">
        <div class="menu-entry">
          <a class="img" style="background-image: url(<?= base_url('coffee1-gh-pages/images/menu-2.jpg') ?>);"></a>
          <div class="text pt-4">
            <h3>Kopi Joss Susu</h3>
            <p>Perpaduan lembut antara kopi gosong dan susu segar.</p>
      ...
      <div class="col-md-3 text-center ftco-animate">
        <div class="menu-entry">
          <a class="img" style="background-image: url(<?= base_url('coffee1-gh-pages/images/menu-3.jpg') ?>);"></a>
          <div class="text pt-4">
            <h3>Kopi Joss Gula Aren</h3>
            <p>Manis alami gula aren yang menyatu dengan aroma kopi panas.</p>
      ...
      <div class="col-md-3 text-center ftco-animate">
        <div class="menu-entry">
          <a class="img" style="background-image: url(<?= base_url('coffee1-gh-pages/images/menu-4.jpg') ?>);"></a>
          <div class="text pt-4">
            <h3>Kopi Joss Racik Sendiri</h3>
            <p>Tentukan biji kopi, tingkat roasting, rasa, dan topping sesuai selera.</p>
            <p class="price"><span>Mulai Rp 10.000</span></p>
            <p><a href="#" class="btn btn-primary btn-outline-primary">Racik</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 text-center ftco-animate">
        <div class="menu-entry">
          ...
          <div class="text pt-4">
            ...
            <p class="price"><span>Rp 21.000</span></p>
            <p><a href="#" class="btn btn-primary btn-outline-primary">Tambah</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 text-center ftco-animate">
        <div class="menu-entry">
          ...
          <div class="text pt-4">
            ...
            <p class="price"><span>Rp 24.000</span></p>
            <p><a href="#" class="btn btn-primary btn-outline-primary">Tambah</a></p>
          </div>
        </div>
      </div>
